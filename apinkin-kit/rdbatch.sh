#!/bin/bash
    ...
    for file in example_bots/RageBot.jar example_bots/DualBot.jar
    ...
    do
       ...
       for i in {1..50}
       do
          RES=`java -jar tools/PlayGame.jar maps/map_r538_$i.txt 1000 200 log.txt "java -jar $file" "python $BOT" 2>&1 | tail -n 3 | grep "Turn\|Player"`
