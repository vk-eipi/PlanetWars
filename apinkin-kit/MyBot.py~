...
from planetwars.universe_custom2 import MyUniverse
from planetwars.temp2_planet2 import Planet2
            ...
            if len(self.universe.frontlines) > 0:
                ...
                for p in my_planets:
                    if p.available*MyBot.fraction_available >= 1:
                        ...
                        supply_target = min(self.universe.frontlines, key = lambda x: (p.distance(x), -x.ship_count))
