# wins against frontlinesbot.py (frontline sends to self bug) about 14:8(28draws)
# wins slower and loses faster by a few moves than frontlinesbot on average against rallybot
'''
